...
1. Create ansible playbooks to create **[deployment](https://github.com/harshhaareddy/My_DevOps_Project/blob/master/Kubernetes/kubernetes-my-deployment.yml)** and **[services](https://github.com/harshhaareddy/My_DevOps_Project/blob/master/Kubernetes/kubernetes-my-service.yml)** 
